...
Sparkle: main.o RegimeContainer.o Regime.o Pathes.o ImageAverager.o StandaRotationStage.o StandaActuator.o HWPRotation.o MirrorMotion.o CommandLogger.o
	g++ -o Sparkle main.o RegimeContainer.o Regime.o Pathes.o ImageAverager.o StandaRotationStage.o StandaActuator.o HWPRotation.o MirrorMotion.o CommandLogger.o -landor -lncurses -lximc -lcfitsio
